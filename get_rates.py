...
def keyPolicyRate():
    ...
    if delta[2] > 0:
        url = 'https://data.norges-bank.no/api/data/IR/B.KPRA.SD.?format=csv&startPeriod={}&endPeriod={}&locale=en'.format(delta[1], delta[0])
...
def nowa():
    ...
    if delta[2] > 0:
        url = 'https://data.norges-bank.no/api/data/IR/B.NOWA..?format=csv&startPeriod={}&endPeriod={}&locale=en'.format(delta[1], delta[0])
        res = requests.get(url)
...
def treasuryBills():
    ...
    if delta[2] > 0:
        url = 'https://data.norges-bank.no/api/data/IR/B.TBIL..?format=csv&startPeriod={}&endPeriod={}&locale=en'.format(delta[1], delta[0])
        res = requests.get(url)
...
def governmentBonds():
    ...
    if delta[2] > 0:
        url = 'https://data.norges-bank.no/api/data/IR/B.GBON..?format=csv&startPeriod={}&endPeriod={}&locale=en'.format(delta[1], delta[0])
        res = requests.get(url)
...
def exchangeRates():
    ...
    if delta[2] > 0:
        url = 'https://data.norges-bank.no/api/data/EXR/B..NOK.SP?format=csv&startPeriod={}&endPeriod={}&locale=en'.format(delta[1], delta[0])
        res = requests.get(url)
